...
<Container>
        <Heading className="font-sans font-bold text-4xl text-primaryColor pb-11" text="New Arrivals" as="h2"/>
        <Flex className=" gap-10">
            <div className=" w-1/4 relative group">
                <Image src={product01} className=" w-full"/>
           ...
           <div className=' bg-white w-full absolute bottom-[78px] py-[25px]  invisible group-hover:visible delay-500'>
            ...
            <div className=" w-1/4 relative group">
                <Image src={product02} className=" w-full"/>
              <div className=" absolute top-4 left-4">
                <Badge text="new" />
              </div>
              <Flex className="justify-between py-4">
            ...
            <div className=" w-1/4 relative group">
                <Image src={product03} className=" w-full"/>
              <div className=" absolute top-4 left-4">
                <Badge text="new" />
              </div>
              <Flex className="justify-between py-4">
            ...
            <div className=" w-1/4 relative group">
                <Image src={product04} className=" w-full"/>
              <div className=" absolute top-4 left-4">
                <Badge text="new" />
              </div>
              <Flex className="justify-between py-4">
